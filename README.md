...
Look at the individual pages for [Concur (Haskell)](https://github.com/ajnsit/concur), or [purescript-concur (Purescript)](https://github.com/ajnsit/purescript-concur** for installation instructions.
